...
class DescriptionPlace extends StatelessWidget {
  ...
  DescriptionPlace(this.namePlace, this.stars, this.description, {super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final title_stars = Row(
      children: <Widget>[
        ...
        Row(
          children: <Widget>[star, star, star, star, start_boder],
        )
      ],
    );
    ...
    return Column(
      ...
      children: <Widget>[title_stars, descriptionContainer, const Button()],
    );
  }
}
